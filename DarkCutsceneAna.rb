  ...
  MAP_609_DIALOGUE = {
    2 => {
      1 => ["ANA: Melia... what just happened?",
        ...
        "But if she wakes up, what if she..."]
    },
    13 => {
      0 => ["???: Mmmgh...",
        "???: ...Where... Where am I?",
    ...
    30 => {
      9 => [
        ...
        "ANA: You just dropped something...",
        "MELIA: Huh?"]
    },
    32 => {
      10 => ["ANA: ...It appears to be your journal.",
        ...
        "In that case, it's no business of mine to read...",
        ...
        "Except for one thing. One person. \\v[701].",
        ...
        "\\v[701] believes that if we keep going we'll find an out, eventually.",
        ...
        "\\v[701] and I walked down this endlessly long tunnel today.",
        ...
        "\"MELIA: Entry 2,211.",
        "\\v[701] went out on their own again.",
        "I've given up.",
        ...
        "When \\v[701] comes back, I might kill them. Just for fun.",
        ...
        "...",
        "I am so sorry, \\v[701]...",
        "ANA: It's... Okay. I didn't check up on her enough.",
        "I was so focused on \"escaping\"... But there isn't any escaping here.",
        "Where we are, is just where we are.",
        "MELIA: ...No. There is a way out.",
        "ANA: ...If you mean how the \"other\" you escaped... We don't know if that's really what happened.",
        ...
        "ANA: Even if we are able to escape... We'd just be back in our old problems.",
        "Team Xen...",
    ...
    47 => {
      124 => ["ANA: Melia, we did it! There's a door!",
        ...
        "ANA: ...",
        "If you were correct, \\PN is the key.",
        "If I overtake \\PN, we'll just lose again.",

...
MUSIC_SIGNPOST_MAPPING = {
  ...
  "Mood - Comeback_1" => "[Music] Mood - Time for a Comeback",
  ...
  "Rejuvenation - Title Screen_2" => "[Awakening] Painful Truth II",
  "Rejuvenation - Title Screen" => "[Awakening] Painful Truth I",
